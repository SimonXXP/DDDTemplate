...
namespace ShineTechQD.DDDCodeGenerator.Common.Generators
{
    ...
    public class IQueryServicHelper : BaseHelper
    {

        public IQueryServicHelper(string _enetity_name_and_namespace)
        {
        ...
        public void Create_Code()
        {
            ...
            string template_folder = context.Server.MapPath(settings.folder_templates + settings.template_folder_query_service_interface);
            string template_file = template_folder + "I{{entity_sub_namespace}}QueryService.cs";
