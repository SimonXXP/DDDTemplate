...
{
    public class DomainModelsIdentitiesHelper : BaseHelper
    {

        public DomainModelsIdentitiesHelper(string _enetity_name_and_namespace)
        {
        ...
        public void Create_Code()
        {
            ...
            string template_folder = context.Server.MapPath(settings.folder_templates + settings.template_folder_domain_models_identities);
            string template_file = template_folder + "{{entity_sub_namespace}}ID.cs";
